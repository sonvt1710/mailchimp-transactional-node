...
var Mctemplates = require('./api/MctemplatesApi');
...
var exports = function (apiKey = '') {
  this.basePath = 'https://mandrillapp.com/api/1.3';
  this.apiKey = apiKey;
  ...
  this.requestConfig = {
    headers: {
      'User-Agent': 'MailchimpTransactional-JS/1.3.3',
    },
  };
  ...
  this.mctemplates = new Mctemplates(this);
